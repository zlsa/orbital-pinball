...
function style_init_pre() {
  prop.style = {};

  prop.style.crew = {};

  prop.style.crew.size = [72, 100];

  prop.style.crew.head = {}
  prop.style.crew.head.size = [48, 80];
  prop.style.crew.head.curve = 18;
  prop.style.crew.head.hair_height = 15;
